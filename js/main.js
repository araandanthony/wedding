$(document).ready(function() {
    ...
    map.addMarker({
        ...
        infoWindow: {
            content: '<div class="note">Ceremony</div><h4 class="map-title script">Parish of Immaculate Heart of Mary\'s Church</h4><div class="address"><span class="region">Daang Bakal Road</span><br><span class="postal-code">1870</span><br><span class="city-name">Antipolo City</span></div>'
        }
